    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                remappings=[
                    ("raw_gps_1", "/novatel_interface/gps"),
                    ("raw_imu_1", "/novatel_interface/imu"),
                    ("raw_gps_2", "/gps_front/gps"),
                    ("raw_imu_2", "/gps_front/imu"),
                    ("raw_gps_3", "/gps_back/gps"),
                    ("raw_imu_3", "/gps_back/imu"),
                    ("steering_report", "/vehicle/steering_report"),
                    ("vehicle_kinematic_state", "/vehicle/state"),
                    ("heading_diff", "/car_heading_stamped"),
                ],
                emulate_tty=True,
                condition=IfCondition(
                    EqualsSubstitution(LaunchConfiguration("vehicle_name"), "HAWAII_GOKART")
                ),
            ),
            Node(
