...
: rclcpp::Node("lgsvl_interface", options)
{
  ...
  origin_.altitude = this->get_parameter("origin.altitude").as_double();
  origin_.latitude = this->get_parameter("origin.latitude").as_double();
  origin_.longitude = this->get_parameter("origin.longitude").as_double();
